...
export default {
  ...
  data: () => ({
      ...
      items2: [
        { icon: 'mdi-format-page-break', iconClass: 'blue white--text', title: 'Vacation itinerary', subtitle: 'Jan 20, 2014' },
        { icon: 'mdi-format-rotate-90', iconClass: 'amber white--text', title: 'Kitchen remodel', subtitle: 'Jan 10, 2014' },
      ],
  })
};
</script>