...
export default {
  ...
  data: () => ({
    dialog: false,
        ...
        items2: [
          { icon: 'mdi-file-document', iconClass: 'blue white--text', title: 'Vacation itinerary', subtitle: 'Jan 20, 2014' },
          { icon: 'mdi-floppy', iconClass: 'amber white--text', title: 'Kitchen remodel', subtitle: 'Jan 10, 2014' },
        ],
  })
};
</script>